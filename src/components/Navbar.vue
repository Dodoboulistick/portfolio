    ...
    <div class="container flex items-center justify-between">
      <div>
        <a href="#">
          <img
            v-if="isDark"
            src="/src/assets/logoDMblack.svg"
            class="h-7 opacity-90"
            alt="Logo of dorian-mailhe.fr white version"
          />
          <img
            v-else
            src="/src/assets/logoDMwhite.svg"
            class="h-7"
            alt="Logo of dorian-mailhe.fr dark version"
          />
        </a>
      </div>
      <div class="flex items-center">
        <ul
          class="lg:flex flex-row items-center gap-5 font-medium text-lg capitalize hidden"
        >
        ...
        <div
          class="w-[1px] h-5 bg-gray-900 dark:bg-white/90 mx-5 hidden lg:block"
        ></div>
        <ul class="flex items-center gap-5 font-medium">
          ...
          <li>
            <i
              @click="toggleDark()"
              class="bi text-2xl nav-link"
              :class="[isDark ? 'bi-sun' : 'bi-moon']"
            ></i>
          </li>
          <li>
            <a href="https://github.com/Dodoboulistick" target="_blank"
              ><i class="bi bi-github text-2xl nav-link"></i
            ></a>
          </li>
        </ul>
        <div
          class="w-[1px] h-5 bg-gray-900 dark:bg-white/90 mx-5 lg:hidden"
        ></div>
        <div class="flex flex-col items-center">
          <i
            @click="onClickNav"
            class="bi bi-list text-3xl transition-all duration-300 lg:hidden w-fit h-fit"
            :class="{ 'rotate-90': toggleNav }"
          ></i>
