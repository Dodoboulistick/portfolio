    ...
    <section class="container py-10">
        ...
        <div class="grid grid-cols-12 gap-20 items-center py-10">
            ...
            <div class="col-span-7 grid grid-cols-2 gap-8">
                <div v-for="item in items" class="px-5 py-4 rounded-xl shadow-lg bg-gray-50 cursor-pointer hover:border-blue-600 transition-all duration-300" :class="[item.isActive ? 'border-2 border-blue-600' : 'border-2 border-gray-50' ]" @click="handleClick(item.index)">
